      ...
      >
        ...
        >
          <p className="mb-10 max-w-2xl font-ovo">
            I am a experience Frontend Developer with over a decade of
            professional expertise in the field. Throughout my career, I have
            honed my skills in crafting visually appealing and user-friendly web
            applications. My passion for coding and problem-solving drives me to
            stay updated with the latest technologies and trends in frontend
            development. I take pride in delivering high-quality code and
            collaborating effectively with cross-functional teams to bring
