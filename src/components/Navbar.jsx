...
const Navbar = ({ isDarkMode, setIsDarkMode }) => {
  ...
  const sideManuRaf = useRef();

  const openMenu = () => {
    sideManuRaf.current.style.transform = "translateX(-16rem)";
  };
    ...
    <>
      ...
      >
        ...
        <ul
          ...
          ${
            isScroll
              ? "dark:bg-darkTheme dark:border dark:border-white/50"
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            href="#contact"
            className="py-2 hidden lg:flex items-center gap-3
